...
ARTIFACT_DOWNLOAD_URL=${ARTIFACT_DOWNLOAD_URL:-$ARTIFACT_URL/$ARTIFACT_VERSION/ibm-ucd-agent-$ARTIFACT_VERSION.zip}
...
docker build -t stackinabox/urbancode-deploy-agent:$ARTIFACT_VERSION --build-arg ARTIFACT_DOWNLOAD_URL=$ARTIFACT_DOWNLOAD_URL --build-arg ARTIFACT_VERSION=$ARTIFACT_VERSION .
